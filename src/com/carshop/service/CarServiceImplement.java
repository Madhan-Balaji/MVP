...
public class CarServiceImplement implements CarService {
	...
	@Override
	public ResponseWithCarCollection getAllCarDetails()
			throws UnknownHostException {
	...
	@Override
	public ResponseWithCarData getCarData(String id)
			throws UnknownHostException {
		return carDetailsDao.getCarDetail(id);
	}

	@Override
	public ResponseWithCarCollection searchCarTerm(String term)
			throws UnknownHostException {
		return carDetailsDao.searchInStrings(term);
	}

	@Override
	public ResponseWithCarCollection getCarsUser(String id)
			throws UnknownHostException {
